...
For a more manageable collection of clear examples, this GitHub repository contains a collection of French novels (_romans_).
...
The OTA is one of the oldest archives of digital literary texts and holds a vast collection of TEI-encoded materials, including the files for _Early English Books Online_ (EEBO) and _Eighteenth Century Collections Online_ (ECCO).
